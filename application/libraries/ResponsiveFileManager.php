...
// define	('__DBCLASS' , APPPATH . 'libraries/SqlHelper/'); /*** file path ***/
#[AllowDynamicProperties]
class ResponsiveFileManager
{
	public $ci;
	public $use_access_keys = false;
	public $debug_error_message = true;
		...
		*/
		...
		$config = array(
		    ...
		    */
		    ...
		    |
		    */
		    'current_path' => FCPATH.'assets/source/',
		    ...
		    |
		    */
		    'thumbs_base_path' => FCPATH.'assets/thumbs/',
		    ...
		    |
		    */
		    'thumbs_upload_dir' => FCPATH.'assets/thumbs/',
