...
<div>
   <div nonce="<?php echo $CI->nonceV; ?>" class="brand">
      <img nonce="<?php echo $CI->nonceV; ?>" class="brand-img h-80 mt-60" src="<?php echo assetPath(); ?>images/brand.png" alt="..."><img class="brand-img h-80 mt-60 ml-20" src="<?php echo assetPath(); ?>images/bagongpilipinas2.png" alt="...">
      <br>
   ...
   <div class="page-register-bg">
      <div class="panel bg-transparent">
         <div class="panel-body">
            ...
            <h1 class="text-success" style="text-align: center">Account Activation Link Expired!</h1>
            <h5 class="text-center text-white mt-30">Account activation is only allowed within 24Hrs.</h5>
            <h5 class="text-center text-white mt-30">New Account Activation Link is successfully sent to your registered email address.</h5>
            ...
            <div class="" style="width:100%;margin-top:20px;">
               <div style="font-size:12px;text-align:center;margin-top:30px;">
                  Please click <a class="text-successs" href="<?php echo site_url(); ?>">here</a> to redirect to login page. 
               </div>
...
<script  id="removethis" nonce="<?php echo $CI->nonceV; ?>" type="text/javascript">
   ...
   var r=setInterval(function()
   {
      ...
      if(ct < 8)
      {
         $("span[id='autoredirect']").removeClass('text-success').addClass('text-warning');
      }
