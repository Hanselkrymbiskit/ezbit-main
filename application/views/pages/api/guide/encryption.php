  ...
  <div class="card-body">
  	...
  	<div>
  		<table class="table table-sm" style="">
  			...
  			<tbody>
  				<tr>
  					<td style="width:50%;text-align: center">DRIVER</td>
  					<td>: <b style="margin-left:10%">OpenSSL</b></td>
  				</tr>
  				<tr>
  					<td style="width:50%;text-align: center">CIPHER NAME</td>
  					<td>: <b style="margin-left:10%">AES-256</b></td>
  				</tr>
  				<tr>
  					<td style="text-align: center">KEY LENGTHS [ bits / bytes ]</td>
  					<td>: <b style="margin-left:10%">256 / 32</b></td>
  				</tr>
  				<tr>
  				...
  				<tr>
  					...
  					<td>: <b style="margin-left:10%">FALSE</b></td>
  				</tr>
  			</tbody>
  		</table>
  		<p>Provided Encryption Key is a Binary Key and coded to Base64 Format for easy handling.</p>
  		<p>If the Encryption Key doesn't work, please change your password to trigger key set regeneration.</p>
  	</div>
	  		...
	  		<div>
				<div style="margin-top: 1rem">
					...
					<ol style="margin-top: 1rem">
	  				...
	  				<li>Encrypt the data via AES-256 in CBC mode, using the above-mentioned derived encryption key and IV.</li>
					  	...
					  	<div class="form-row align-items-center">
							<div class="col-auto">
								...
								<div class="input-group mb-2">
									...
									<input type="text" id="generatedkeys" name="Form_Data" class="form-control" id="inlineFormInputGroup" placeholder="" autocomplete="off" style="width:65vw;text-align: center">
								</div>
							</div>
							<div class="col-auto">
