						...
						<tbody>
							...
							<tr>
								<td class="border-top-0  pt-0 pl-20 pr-20 pb-20 ">
					                ...
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[copayment][wcp]" name="request[copayment]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="wcp" title="Co-pay" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['copayment'] == 'wcp' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[copayment][wcp]"><i class="ml-20">Co-pay</i></label>
					...
					<tr>
						<td class="border-bottom-0 font-weight-bold font-size-16 pt-20 pl-20 pr-20 pb-0 w-p50">
							<div class="form-group form-material mb-0" data-plugin="formMaterial">
								<label class="label font-weight-bold text-uppercase"  for="request[crtby_attendingophthalmologist]">Certified correct by: </label>
				                <input type="text" class="form-control text-uppercase bt-white text-primary text-center" id="request[crtby_attendingophthalmologist]" name="request[crtby_attendingophthalmologist]" title="Certified correct by Attending Rehabilitation Medicine Specialist" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" placeholder="Complete Name" autocomplete="eFormData_off" formgroup="preauthFormData" value="<?php echo @$preauthFormData['request']['crtby_attendingophthalmologist']; ?>" dfvalue="<?php echo @$preauthFormData['request']['crtby_attendingophthalmologist']; ?>" onKeyPress="return isAllowedChar(event)" <?php echo @$disabled; ?> required>       
			              	</div>
						</td>
						<td class="border-bottom-0 font-weight-bold font-size-16 pt-20 pl-20 pr-20 pb-0 w-p50">
							<div class="form-group form-material mb-0" data-plugin="formMaterial">
					...
					<tr>
						<td class="border-top-0 font-size-16 p-0 w-p50 text-center">
							<div class="form-group form-material mb-0 row" data-plugin="formMaterial">
								<label class="col-md-6 label font-size-14 text-uppercase mt-5"  for="request[crtby_attendingophthalmologist_accreno]">PhilHealth Accreditation No :</label>
								<div class="col-md-6">
				                	<input type="text" class="form-control text-uppercase bt-white text-primary font-size-16" id="request[crtby_attendingophthalmologist_accreno]" name="request[crtby_attendingophthalmologist_accreno]" title="Pediatric Cardiology - Accreditation No." forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" placeholder="0000-0000000-0" autocomplete="eFormData_off" formgroup="preauthFormData" value="<?php echo @$preauthFormData['request']['crtby_attendingophthalmologist_accreno']; ?>" dfvalue="<?php echo @$preauthFormData['request']['crtby_attendingophthalmologist_accreno']; ?>"   data-plugin="formatter"  data-pattern="[[9999]]-[[9999999]]-[[9]]" <?php echo @$disabled; ?> required>    
				                </div>   
			              	</div> 
						</td>
						<td class="border-top-0 font-size-16 p-0 w-p50 text-center">
