					...
					<table class="table table-sm border">
						<tbody>
							...
							<tr>
								<td class="border-top-0  pt-0 pl-20 pr-20 pb-20 ">
									<div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_9]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="9" title="femoral" autocomplete="eFormData_off" <?php echo @$disabled; ?>  <?php echo (@$preauthFormData['request']['typeimplant'] == '9' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_9]"><i class="ml-20"></i>femoral</label>
					                </div>   
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_10]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="10" title="tibial" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '10' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_10]"><i class="ml-20"></i>tibial</label>
					                </div> 
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_11]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="11" title="Intramedullary nail with interlocking screws" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '11' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_11]"><i class="ml-20"></i>Intramedullary nail with interlocking screws</label>
					                </div> 
					              	<div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_12]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="12" title="Locked compression plate- broad, metaphyseal, proximal and distal:  " autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '12' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_12]"><i class="ml-20"></i>Locked compression plate- broad, 
metaphyseal, proximal and distal:  </label>
					                </div>
								</td>
							</tr>
