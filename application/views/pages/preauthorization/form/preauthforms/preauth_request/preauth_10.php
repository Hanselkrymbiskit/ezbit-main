					...
					<table class="table table-sm border">
						<tbody>
							...
							<tr>
								<td class="border-top-0  pt-0 pl-20 pr-20 pb-20 ">
									<div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_6]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="6" title="Compression hip screw set" autocomplete="eFormData_off" <?php echo @$disabled; ?>  <?php echo (@$preauthFormData['request']['typeimplant'] == '6' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_6]"><i class="ml-20"></i>Compression hip screw set</label>
					                </div>   
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_7]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="7" title="Proximal femoral locked plate" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '7' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_7]"><i class="ml-20"></i>Proximal femoral locked plate </label>
					                </div> 
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_8]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="8" title="Proximal femoral nail" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '8' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_8]"><i class="ml-20"></i>Proximal femoral nail</label>
					                </div> 
