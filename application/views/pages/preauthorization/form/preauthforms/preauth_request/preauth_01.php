		...
		<div class="mb-5">
			<table class="table table-sm table-bordered">
				<tbody>
					<tr>
						<td class="border-bottom-0 font-weight-bold font-size-16 pt-20 pl-20 pr-20 pb-0 w-p50">
							<div class="form-group form-material mb-0" data-plugin="formMaterial">
								<label class="label font-weight-bold text-uppercase"  for="request[crtby_attendingphysician]">Certified correct by: </label>
				                <input type="text" class="form-control text-uppercase bt-white text-primary text-center" id="request[crtby_attendingphysician]" name="request[crtby_attendingphysician]" title="Certified correct by Attending Physician" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" placeholder="Complete Name" autocomplete="eFormData_off" formgroup="preauthFormData" value="<?php echo @$preauthFormData['request']['crtby_attendingphysician']; ?>" dfvalue="<?php echo @$preauthFormData['request']['crtby_attendingphysician']; ?>" onKeyPress="return isAllowedChar(event)" <?php echo @$disabled; ?> required>       
			              	</div>  
						</td>
						<td class="border-bottom-0 font-weight-bold font-size-16 pt-20 pl-20 pr-20 pb-0 w-p50">
							<div class="form-group form-material mb-0" data-plugin="formMaterial">
					...
					<tr>
						<td class="border-top-0 font-size-16 p-0 w-p50 text-center">
							<div class="form-group form-material mb-0 row" data-plugin="formMaterial">
								<label class="col-md-6 label font-size-14 text-uppercase mt-5"  for="request[crtby_attendingphysician_accreno]">PhilHealth Accreditation No :</label>
								<div class="col-md-6">
				                	<input type="text" class="form-control text-uppercase bt-white text-primary font-size-16" id="request[crtby_attendingphysician_accreno]" name="request[crtby_attendingphysician_accreno]" title="Attending Physician - Accreditation No." forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" placeholder="0000-0000000-0" autocomplete="eFormData_off" formgroup="preauthFormData" value="<?php echo @$preauthFormData['request']['crtby_attendingphysician_accreno']; ?>" dfvalue="<?php echo @$preauthFormData['request']['crtby_attendingphysician_accreno']; ?>"   data-plugin="formatter"  data-pattern="[[9999]]-[[9999999]]-[[9]]" <?php echo @$disabled; ?> required>    
				                </div>   
			              	</div>  
						</td>
						<td class="border-top-0 font-size-16 p-0 w-p50 text-center">
					...
					<tr>
						<td colspan="2" class="border-top-0 font-size-16 p-20 text-center">
							<div class="form-group form-material mb-0" data-plugin="formMaterial">
								<label class="label font-weight-bold text-uppercase"  for="request[crtby_parent_guardian]">Conforme by: </label>
				                <input type="text" class="form-control text-uppercase bt-white text-primary text-center" id="request[crtby_parent_guardian]" name="request[crtby_parent_guardian]" title="Parent/Guardian" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" placeholder="Parent/Guardian Name" autocomplete="eFormData_off" formgroup="preauthFormData" value="<?php echo @$preauthFormData['request']['crtby_parent_guardian']; ?>" dfvalue="<?php echo @$preauthFormData['request']['crtby_parent_guardian']; ?>" onKeyPress="return isAllowedChar(event)" <?php echo @$disabled; ?> required><h6>Parent/Guardian</h6>  
			              	</div>
						</td>
					</tr>
				</tbody>
