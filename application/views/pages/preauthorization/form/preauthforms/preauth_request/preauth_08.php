...
<div class="row">
	...
	<div class="col-lg-8">
		...
		<div class="mb-5">
			<div class="row">
				<h4 class="col-lg-12 col-md-12 text-left">The patient is aware of the PhilHealth policy on co-payment and agreed to avail of the benefits package (please tick appropriate box): </h4>
					...
					<table class="table table-sm border">
						<tbody>
							...
							<tr>
								<td class="border-top-0  pt-0 pl-20 pr-20 pb-20 ">
									<div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_1]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="1" title="Total hip prosthesis (cemented)" autocomplete="eFormData_off" <?php echo @$disabled; ?>  <?php echo (@$preauthFormData['request']['typeimplant'] == '1' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_1]"><i class="ml-20"></i>Total hip prosthesis (cemented) </label>
					                </div>   
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_2]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="2" title="Total hip prosthesis (cementless))" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '2' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_2]"><i class="ml-20"></i>Total hip prosthesis (cementless)</label>
					                </div> 
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_3]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="3" title="Total hip prosthesis (hybrid)" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '3' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_3]"><i class="ml-20"></i>Total hip prosthesis (hybrid)</label>
					                </div> 
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_4]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="4" title="Partial hip prosthesis (bipolar)" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '4' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_4]"><i class="ml-20"></i>Partial hip prosthesis (bipolar)</label>
					                </div> 
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[typeimplant_5]" name="request[typeimplant]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="5" title="Partial hip prosthesis (unipolar/modular)" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['typeimplant'] == '5' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[typeimplant_5]"><i class="ml-20"></i>Partial hip prosthesis (unipolar/modular)</label>
					                </div>   
								</td>
							</tr>
