...
<div class="row">
	...
	<div class="col-lg-8">
		...
		<div class="mb-5">
			<div class="row">
				<h4 class="col-lg-12 col-md-12 text-left">The patient belongs to the following category (please tick appropriate box):</h4>
				...
				<div class="col-md-6 col-lg-6">
					<table class="table table-sm border">
						<tbody>
							<tr>
								<td class="text-dark border-0 text-left font-size-16 p-20">Treatment modality: (tick appropriate box)</td>
							</tr>
							<tr>
								<td class="border-top-0  pt-0 pl-20 pr-20 pb-20 ">
									<div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[treatmentmodality][1]" name="request[treatmentmodality]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="1" title="chemoradiation: chemotherapy, cobalt and brachytherapy (low dose) or primary surgery for stage IA1, IA2-IIA1" autocomplete="eFormData_off" <?php echo @$disabled; ?>  <?php echo (@$preauthFormData['request']['treatmentmodality'] == '1' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[treatmentmodality][1]"><i class="ml-20">chemoradiation: chemotherapy, cobalt and brachytherapy (low dose) or primary surgery for stage IA1, IA2-IIA1</i></label>
					                </div>   
					                <div class="radio checkbox-custom custom-control checkbox-primary mb-0 mt-0">
					                    <input type="radio" id="request[treatmentmodality][2]" name="request[treatmentmodality]" class="form-control" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" value="2" title="chemoradiation: chemotherapy, linear accelerator and brachytherapy (low/high dose)" autocomplete="eFormData_off" <?php echo @$disabled; ?> <?php echo (@$preauthFormData['request']['treatmentmodality'] == '2' ) ? 'checked' : ''; ?> >
					                    <label class="font-size-16 text-uppercase text-dark" for="request[treatmentmodality][2]"><i class="ml-20">chemoradiation: chemotherapy, linear accelerator and brachytherapy (low/high dose)</i></label>
					                </div>   
								</td>
							</tr>
					...
					<tr>
						<td class="border-bottom-0 font-weight-bold font-size-16 pt-20 pl-20 pr-20 pb-0 w-p50">
							<div class="form-group form-material mb-0" data-plugin="formMaterial">
								<label class="label font-weight-bold text-uppercase"  for="request[crtby_attendingqynecologiconcologist]">Certified correct by: </label>
				                <input type="text" class="form-control text-uppercase bt-white text-primary text-center" id="request[crtby_attendingqynecologiconcologist]" name="request[crtby_attendingqynecologiconcologist]" title="Certified correct by Attending Cardiologist" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" placeholder="Complete Name" autocomplete="eFormData_off" formgroup="preauthFormData" value="<?php echo @$preauthFormData['request']['crtby_attendingqynecologiconcologist']; ?>" dfvalue="<?php echo @$preauthFormData['request']['crtby_attendingqynecologiconcologist']; ?>" onKeyPress="return isAllowedChar(event)" <?php echo @$disabled; ?> required>       
			              	</div>  
						</td>
						<td class="border-bottom-0 font-weight-bold font-size-16 pt-20 pl-20 pr-20 pb-0 w-p50">
							<div class="form-group form-material mb-0" data-plugin="formMaterial">
					...
					<tr>
						<td class="border-top-0 font-size-16 p-0 w-p50 text-center">
							<div class="form-group form-material mb-0 row" data-plugin="formMaterial">
								<label class="col-md-6 label font-size-14 text-uppercase mt-5"  for="request[crtby_attendingqynecologiconcologist_accreno]">PhilHealth Accreditation No :</label>
								<div class="col-md-6">
				                	<input type="text" class="form-control text-uppercase bt-white text-primary font-size-16" id="request[crtby_attendingqynecologiconcologist_accreno]" name="request[crtby_attendingqynecologiconcologist_accreno]" title="Attending Physician - Accreditation No." forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" placeholder="0000-0000000-0" autocomplete="eFormData_off" formgroup="preauthFormData" value="<?php echo @$preauthFormData['request']['crtby_attendingqynecologiconcologist_accreno']; ?>" dfvalue="<?php echo @$preauthFormData['request']['crtby_attendingqynecologiconcologist_accreno']; ?>"   data-plugin="formatter"  data-pattern="[[9999]]-[[9999999]]-[[9]]" <?php echo @$disabled; ?> required>    
				                </div>   
			              	</div>  
						</td>
						<td class="border-top-0 font-size-16 p-0 w-p50 text-center">
					...
					<tr>
						...
						<td class="border-bottom-0 font-weight-bold font-size-16 pt-20 pl-20 pr-20 pb-0 w-p50">
							<div class="form-group form-material mb-0" data-plugin="formMaterial">
				                ...
				                <input type="text" class="form-control text-uppercase bt-white text-primary text-center" id="request[crtby_patient]" name="request[crtby_patient]" title="Certified correct by Attending Physician" forminputgroup="preauthFormData" forminputgroupcheck="preauthFormData" placeholder="Patient Complete Name" autocomplete="eFormData_off" formgroup="preauthFormData" value="<?php echo @$preauthFormData['request']['crtby_patient']; ?>" dfvalue="<?php echo @$preauthFormData['request']['crtby_patient']; ?>" onKeyPress="return isAllowedChar(event)" <?php echo @$disabled; ?> required>
			              	</div>
						</td>
					</tr>
					<tr>
