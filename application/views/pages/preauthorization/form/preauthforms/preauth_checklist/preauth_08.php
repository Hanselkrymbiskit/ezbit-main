...
$qualitifationlist2 = [
	[
		'title' 	=> 'Hip fracture: (tick appropriate description):',
		'fieldid' 	=> 'q_2_0',
		'noinput'	=> true,
		'sub'		=> false,
		'hassub'    => true,
	...
	[
		'title' 	=> '- with avascular necrosis of the femoral head',
		'fieldid' 	=> 'q_2_1',
		'noinput'	=> false,
		'sub'		=> true,
		'hassub'    => false,
	...
	[
		'title' 	=> '- Neglected fracture of the hip',
		'fieldid' 	=> 'q_2_2',
		'noinput'	=> false,
		'sub'		=> true,
		'hassub'    => false,
	...
	[
		'title' 	=> '- Hip fracture with pre-existing cox-arthritis',
		'fieldid' 	=> 'q_2_3',
		'noinput'	=> false,
		'sub'		=> true,
		'hassub'    => false,
	...
	[
		'title' 	=> 'With avascular necrosis of the femoral head (FICAT Stage III and IV)',
		'fieldid' 	=> 'q_2_5',
		'noinput'	=> false,
		'sub'		=> false,
		'hassub'    => false,
	...
	[
		'title' 	=> 'Hip dysplasia with subsequent osteoarthritis (CROWNE I-IV) ',
		'fieldid' 	=> 'q_2_6',
		'noinput'	=> false,
		'sub'		=> false,
		'hassub'    => false,
	...
	[
		'title' 	=> 'Severe degenerative osteoarthritis',
		'fieldid' 	=> 'q_2_7',
		'noinput'	=> false,
		'sub'		=> false,
		'hassub'    => false,
	...
	[
		'title' 	=> 'Severe inflammatory joint disease (rheumatoid, gout, psoriatic, ankylosing, spondylitis, SLE)',
		'fieldid' 	=> 'q_2_8',
		'noinput'	=> false,
		'sub'		=> false,
		'hassub'    => false,
		...
		<tr>
			...
			<td class="align-middle text-center '.$borderbottom.' '.$bordertop.' ">
				...
				<div class="radio radio-custom custom-control radio-primary radio-inline">
                    ...
                    <label class="font-size-16 text-uppercase" for="checklist['.$q2prop['fieldid'].'_Y]">YES</label>
                </div>  
                <div class="radio radio-custom custom-control radio-primary radio-inline">
                    ...
                    <label class="font-size-16 text-uppercase" for="checklist['.$q2prop['fieldid'].'_NA]">N/A</label>
                </div>   
                ' : '').'
			</td>
		</tr>
				...
				<td class="w-p80 text-left font-weight-bold text-dark p-10 font-size-16 align-middle">
					<div class="form-group form-material mb-0" data-plugin="formMaterial">
		                ...
		                <div class="radio radio-custom custom-control radio-primary radio-inline">
		                    ...
		                    <label class="font-size-16 text-uppercase" for="checklist[q_0_1_B]">Both side</label>
		                </div>
	                </div>
				</td>
			</tr>
