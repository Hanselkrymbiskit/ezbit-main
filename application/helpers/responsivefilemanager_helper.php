...
//     die('forbiden');
// }
require FCPATH.'assets/filemanager/include' . '/Response.php';
...
if ( ! function_exists('trans'))
{
    ...
    */
    function trans($var,$lang_vars = '')
    {
        $CI = & get_instance();
        global $lang_vars;
        if( !isset($lang_vars) && !is_array($lang_vars))
        {
                $lang_vars = $CI->data['lang_vars'];
        }
...
if (!function_exists('checkRelativePathPartial')) {
...
if (!function_exists('checkRelativePath')) {
    /**
    * Check relative path
    *
    * @param  string  $path
...
if (!function_exists('isUploadDir')) {
    /**
...
if (!function_exists('checkresultingsize')) {
/**
...
if (!function_exists('check_files_extensions_on_path')) {
/**
...
if (!function_exists('check_files_extensions_on_phar')) {
...
if (!function_exists('fix_get_params')) {
/**
* Cleanup input
*
* @param  string  $str
...
if (!function_exists('check_extension')) {
...
if (!function_exists('fix_filename')) {
/**
* Cleanup filename
*
* @param  string  $str
...
if (!function_exists('fix_dirname')) {
/**
...
if (!function_exists('fix_strtoupper')) {
/**
...
if (!function_exists('fix_strtolower')) {
/**
...
if (!function_exists('config_loading')) {
/**
* @param  $current_path
* @param  $fld
*
...
if (!function_exists('new_thumbnails_creation')) {
...
if (!function_exists('get_file_by_url')) {
...
if (!function_exists('is_function_callable')) {
...
if (!function_exists('rrename_after_cleaner')) {
...
if (!function_exists('AddErrorLocation')) {
/**
