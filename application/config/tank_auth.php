...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'Knowledge Management and Information Technology Service';
$config['webmaster_email'] = 'germelsevilla@yahoo.com';
...
$config['login_by_email'] = TRUE; // Remove in Login Form
...
|--------------------------------------------------------------------------
*/
$config['autologin_cookie_name'] = 'kmits';
...
$config['captcha_fonts_path'] = $config['captcha_path'].'fonts/5.ttf';
$config['captcha_width'] = 200;
$config['captcha_height'] = 54;
...
$config['recaptcha_public_key'] = '6LcsICMTAAAAAKWojnsnTGbvWwS5aanYdRf86AiJ';
$config['recaptcha_private_key'] = '6LcsICMTAAAAAMO57VCt8i3X5UVRNkm3F-wY12Za';
