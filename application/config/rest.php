...
*/
// $config['auth_override_class_method_http']['Patient']['index']['get'] = 'none';
// $config['auth_override_class_method_http']['Patient']['index']['post'] = 'none';
// ---Uncomment list line for the wildard unit test
...
|
*/
$config['rest_key_name'] = 'NHDR-API-KEY';
