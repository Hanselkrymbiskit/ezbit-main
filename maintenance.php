...
<html class="no-js css-menubar" lang="en">
  <head>
    ...
    <link rel="stylesheet" href="assets/global/vendor/waves/waves.css">
        <link rel="stylesheet" href="assets/css/pages/maintenance.css">
  ...
  <body class="animsition page-maintenance layout-full">
    ...
    <div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">>
      <div class="page-content vertical-align-middle">
        <i class="icon md-settings icon-spin page-maintenance-icon" aria-hidden="true"></i>
    ...
    <script nonce="myself" >Config.set('assets', '/assets');</script>
